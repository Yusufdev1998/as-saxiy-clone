...
const SuggestionCard = () => {
  return (
    ...
    <button
      type="button"
      className="product__item-heart border-0 p-0 bg-transparent"
    >
    ...
    <div className="product__item-img">
      <img
        ...
        data-src="https://assets.asaxiy.uz/product/main_image/desktop//613364d9ccd91.jpg.webp"
        loading="lazy"
        alt='Футболка YOKI "Akang talaba uje" Black'
        src="https://assets.asaxiy.uz/product/main_image/desktop//613364d9ccd91.jpg.webp"
      />
    </div>
    ...
    <div className="product__item-info">
      <a
        ...
        href="/product/odejda-obuv-i-aksessuari/dlya/futbolki/futbolka-yoki-akang-talaba-uje-black"
      >
        <span className="product__item__info-title">
          Футболка YOKI "Akang talaba uje" Black{" "}
        </span>
      </a>
      <div className="product__item-info--rating">
        <div className="product__item-rating--stars">
          <span>
        ...
        <div className="product__item-info--comments">
          <i
            style={{ color: "#c2c6d1" }}
      ...
      <div className="product__item-info--prices">
        <div className="produrct__item-prices--wrapper">
          <span className="product__item-price">
            119 000 сум
          </span>
          <div className="installment__price">
            13 900 сум / 12 мес
          </div>
        </div>
      </div>
    ...
    <div className="mt-4">
      <div className="row s__custom-gutter">
        <div className="col-sm-5" style={{ padding: "3px" }}>
          <BasicLink
            classNames={[
              "default-btn",
              "btn-green",
